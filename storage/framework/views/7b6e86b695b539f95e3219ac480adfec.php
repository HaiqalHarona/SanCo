            ...
            <div x-show="slide === 0" 
                ...
                <div class="relative z-10 flex flex-col justify-between h-full p-8 md:p-10">
                    ...
                    <div class="flex items-center gap-2.5">
                        <img src="<?php echo e(asset('images/logo/SanCo.png')); ?>" class="w-8 h-8 object-contain" alt="SanCo Logo">
        ...
        <div class="flex-1 bg-[#202024] flex flex-col justify-center px-8 md:px-12 py-10 relative overflow-hidden">
            ...
            <div x-data="{ agreed: false }" class="relative w-full max-w-sm mx-auto text-center">
                ...
                <div class="flex justify-center mb-6">
                    <img src="<?php echo e(asset('images/logo/SanCo.png')); ?>" class="h-16 w-auto object-contain" alt="SanCo Logo">
                </div>
...
</div><?php /**PATH /home/ninonakano/Desktop/SanCo/resources/views/livewire/auth.blade.php ENDPATH**/ ?>