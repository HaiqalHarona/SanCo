...
<div
    ...
    <div x-show="showSettings"
        ...
        <div class="relative w-full max-w-4xl bg-white dark:bg-[#1e1e21] rounded-3xl shadow-2xl overflow-hidden border border-gray-200 dark:border-[#2a2a2d] transition-all duration-300 transform max-h-[88vh] flex flex-col"
            ...
            <div class="px-6 md:px-10 pt-8 pb-0 border-b border-gray-200 dark:border-white/10 shrink-0">
            ...
            <div class="p-6 md:p-10 overflow-y-auto custom-scrollbar flex-1">
        ...
        <div x-show="showCropModal" class="fixed inset-0 z-[120] flex items-center justify-center p-4 backdrop-blur-md"
            ...
            <div class="relative w-full max-w-md bg-white dark:bg-[#1e1e21] rounded-3xl overflow-hidden shadow-2xl border border-gray-200 dark:border-white/10 p-6 flex flex-col transform"
                x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-3"
                x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-200"
                x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 translate-y-3">
